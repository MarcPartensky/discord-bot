...
class APIAi:
    ...
    def change_folder(self, ai_id, folder_id, token):
        ...
        return self.session.post(
            url, data={"ai_id": ai_id, "folder_id": folder_id, "token": token}
        ).json()
    ...
    def new(self, folder_id, v2, token):
        url = self.url + "/new/"
        return self.session.post(
            url, data={"folder_id": folder_id, "v2": v2, "token": token}
        ).json()

    def rename(self, ai_id, new_name, token):
        url = self.url + "/rename/"
        return self.session.post(
            url, data={"ai_id": ai_id, "new_name": new_name, "token": token}
        ).json()

    def save(self, ai_id, code, token):
        url = self.url + "/save/"
        return self.session.post(
            url, data={"ai_id": ai_id, "code": code, "token": token}
        ).json()
...
class APIAiFolder:
    ...
    def delete(self, folder_id, token):
        url = self.url + "/delete/"
        return self.session.post(
            url, data={"folder_id": folder_id, "token": token}
        ).json()
    ...
    def rename(self, folder_id, new_name, token):
        url = self.url + "/rename/"
        return self.session.post(
            url, data={"folder_id": folder_id, "new_name": new_name, "token": token}
        ).json()
...
class APIFarmer:
    ...
    def activate(self, farmer_id, code):
        ...
        return self.session.post(
            url, data={"farmer_id": farmer_id, "code": code}
        ).json()

    def change_country(self, country_code, token):
        url = self.url + "/change-country/"
        return self.session.post(
            url, data={"country_code": country_code, "token": token}
        ).json()
    ...
    def change_password(self, password, new_password, token):
        ...
        return self.session.post(
            url,
            data={"password": password, "new_password": new_password, "token": token},
        ).json()
    ...
    def login_token(self, login, password):
        ...
        return self.session.post(
            url, data={"login": login, "password": password}
        ).json()
    ...
    def set_in_garden(self, in_garden, token):
        ...
        return self.session.post(
            url, data={"in_garden": in_garden, "token": token}
        ).json()
    ...
    def unregister(self, password, delete_forum_messages, token):
        ...
        return self.session.post(
            ...
            data={
                "password": password,
                "delete_forum_messages": delete_forum_messages,
                "token": token,
            },
        ).json()
...
class APIFight:
    ...
    def comment(self, fight_id, comment, token):
        ...
        return self.session.post(
            url, data={"fight_id": fight_id, "comment": comment, "token": token}
        ).json()
...
class APIGarden:
    ...
    def start_farmer_challenge(self, target_id, token):
        ...
        return self.session.post(
            url, data={"target_id": target_id, "token": token}
        ).json()
    ...
    def start_solo_challenge(self, leek_id, target_id, token):
        ...
        return self.session.post(
            url, data={"leek_id": leek_id, "target_id": target_id, "token": token}
        ).json()
...
class APILeek:
    ...
    def add_chip(self, leek_id, chip_id, token):
        ...
        return self.session.post(
            url, data={"leek_id": leek_id, "chip_id": chip_id, "token": token}
        ).json()

    def add_weapon(self, leek_id, weapon_id, token):
        url = self.url + "/add-weapon/"
        return self.session.post(
            url, data={"leek_id": leek_id, "weapon_id": weapon_id, "token": token}
        ).json()
    ...
    def delete_register(self, leek_id, key, token):
        ...
        return self.session.post(
            url, data={"leek_id": leek_id, "key": key, "token": token}
        ).json()
    ...
    def remove_weapon(self, weapon_id, token):
        ...
        return self.session.post(
            url, data={"weapon_id": weapon_id, "token": token}
        ).json()

    def rename_crystals(self, leek_id, new_name, token):
        url = self.url + "/rename-crystals/"
        return self.session.post(
            url, data={"leek_id": leek_id, "new_name": new_name, "token": token}
        ).json()
    ...
    def set_ai(self, leek_id, ai_id, token):
        url = self.url + "/set-ai/"
        return self.session.post(
            url, data={"leek_id": leek_id, "ai_id": ai_id, "token": token}
        ).json()

    def set_hat(self, leek_id, hat_id, token):
        url = self.url + "/set-hat/"
        return self.session.post(
            url, data={"leek_id": leek_id, "hat_id": hat_id, "token": token}
        ).json()

    def set_in_garden(self, leek_id, in_garden, token):
        url = self.url + "/set-in-garden/"
        return self.session.post(
            url, data={"leek_id": leek_id, "in_garden": in_garden, "token": token}
        ).json()
    ...
    def set_register(self, leek_id, key, value, token):
        ...
        return self.session.post(
            url, data={"leek_id": leek_id, "key": key, "value": value, "token": token}
        ).json()

    def spend_capital(self, leek, characteristics, token):
        url = self.url + "/spend-capital/"
        return self.session.post(
            url, data={"leek": leek, "characteristics": characteristics, "token": token}
        ).json()
    ...
    def use_potion(self, leek_id, potion_id, token):
        ...
        return self.session.post(
            url, data={"leek_id": leek_id, "potion_id": potion_id, "token": token}
        ).json()
...
class APIMessage:
    ...
    def create_conversation(self, farmer_id, message, token):
        ...
        return self.session.post(
            url, data={"farmer_id": farmer_id, "message": message, "token": token}
        ).json()
    ...
    def quit_conversation(self, conversation_id, token):
        ...
        return self.session.post(
            url, data={"conversation_id": conversation_id, "token": token}
        ).json()
...
class APITeam:
    ...
    def accept_candidacy(self, candidacy_id, token):
        ...
        return self.session.post(
            url, data={"candidacy_id": candidacy_id, "token": token}
        ).json()

    def ban(self, farmer_id, token):
        url = self.url + "/ban/"
        return self.session.post(
            url, data={"farmer_id": farmer_id, "token": token}
        ).json()
    ...
    def move_leek(self, leek_id, to, token):
        ...
        return self.session.post(
            url, data={"leek_id": leek_id, "to": to, "token": token}
        ).json()
    ...
    def set_emblem(self, team_id, emblem, token):
        ...
        return self.session.post(
            url, data={"team_id": team_id, "emblem": emblem, "token": token}
        ).json()
...
class APITestLeek:
    ...
    def update(self, id, data, token):
        url = self.url + "/update/"
        return self.session.post(
            url, data={"id": id, "data": data, "token": token}
        ).json()
...
class APITournament:
    ...
    def comment(self, tournament_id, comment, token):
        ...
        return self.session.post(
            url,
            data={"tournament_id": tournament_id, "comment": comment, "token": token},
        ).json()
...
class APITrophy:
    ...
    def unlock(self, trophy_id, token):
        url = self.url + "/unlock/"
        return self.session.post(
            url, data={"trophy_id": trophy_id, "token": token}
        ).json()
