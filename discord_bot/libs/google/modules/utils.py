...
def _get_search_url(
    ...
    time_mapping = {"hour": "qdr:h", "week": "qdr:w", "month": "qdr:m", "year": "qdr:y"}
    ...
    bare_url = (
        "https://www.google.com/search?" if https else "http://www.google.com/search?"
    )
    url = bare_url + params
